...
def inquiry(request):
    if request.method  == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, "You have already submitted an inquiry for this car. Please wait until we get back to you")
        ...
        send_mail(
                    'New Car Inquiry',
                    'You have a new car inquiry' + car_title + '. Please login to your admin panel for more info.',
                    'adamsjosh.578@gmail.com',
                    [admin_email],
                    fail_silently=False,
                )
